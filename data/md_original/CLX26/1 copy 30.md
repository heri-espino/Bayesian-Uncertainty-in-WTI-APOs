...
Historical Prices
Crude Oil WTI Nov '26 89.00 Call (CLX6|890C)
4.75s -1.61 (-25.31%) 09/22/26 [NYMEX]
Price History for Tue, Sep 22nd, 2026
Notes
Alerts
Watch
Help
...
For more data, Barchart Premier members can download more historical data (going back to Jan. 1, 1980) and can download Intraday, Daily, Weekly, Monthly or Quarterly data on the Historical Data Download page. Additional underlying chart data and study values can be downloaded using the Interactive Charts.
Time
Open
High
Low
